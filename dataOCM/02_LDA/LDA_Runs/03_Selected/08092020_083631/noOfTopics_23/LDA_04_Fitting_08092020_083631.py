...
if __name__ == '__main__':
    ...
    # noOfTopicsFolder = 'noOfTopics_22' # Dataset1: 22
    noOfTopicsFolder = 'noOfTopics_23' # Dataset2: 23
    ...
    csvFileNameOut = dir + '/' + 'LDA_04_Fitting_Master_Data_fitted_' + currDateTime +'.csv'
    ...
    def reportIt():
        ...
        if not os.path.exists(dir):
            os.makedirs(dir)
        shutil.copy2('LDA_04_Fitting.py', dir + '/LDA_04_Fitting_' + currDateTime + '.py')
        # pickle.dump(fittedData, open(dir + '/LDA_04_Fitting_fittedData_' + currDateTime + '.data'))
        with open(dir + '/LDA_04_Fitting_fittedData_' + currDateTime + '.data', 'wb') as f:
            pickle.dump(fittedData, f)
        workbook = xlsxwriter.Workbook(dir + '/LDA_04_Fitting_Report_' + currDateTime + '.xlsx')
